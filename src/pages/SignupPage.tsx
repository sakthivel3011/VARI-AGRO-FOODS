...
const SignupPage = () => {
  ...
  useSeo({
    title: "Sign Up | Vari Agro Foods",
    description: "Create your Vari Agro Foods account",
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // TODO: Implement email/password signup when backend is ready
      setError("Email signup coming soon. Use Google Sign-Up for now.");
    } catch (err) {
      ...
      <Container className="relative z-10 flex min-h-screen items-center justify-center py-12">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-[#f7efe2]">Join us today</p>
          </div>
          ...
          <div className="rounded-2xl border border-[#e8dfd1] bg-white/95 p-8 shadow-2xl backdrop-blur-sm">
            ...
            <form onSubmit={handleEmailSignUp} className="space-y-4">
              <div>
                <label htmlFor="name" className="mb-2 block text-sm font-semibold text-[#2b1f14]">
                  Full Name
                </label>
                <div className="relative">
                  <User size={18} className="absolute left-3 top-3 text-[#7a6d5f]" />
                  <input
                    id="name"
                    type="text"
                    value={name}
              ...
              <div>
                <label htmlFor="confirmPassword" className="mb-2 block text-sm font-semibold text-[#2b1f14]">
                  Confirm Password
                </label>
                <div className="relative">
                  <Lock size={18} className="absolute left-3 top-3 text-[#7a6d5f]" />
            ...
            {/* Terms */}
            <p className="mt-4 text-center text-xs text-[#7a6d5f]">
